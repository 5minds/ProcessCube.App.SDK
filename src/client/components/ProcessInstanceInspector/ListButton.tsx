...
export function ListButton({ onClick }: { onClick: () => void }) {
  return (
    <FlowNodeButton onClick={onClick} title="List Instances">
      <svg className="!app-sdk-fill-white" width="10px" height="10px" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
