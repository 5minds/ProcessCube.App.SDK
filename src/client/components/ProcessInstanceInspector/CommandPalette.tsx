  ...
  return (
    ...
    >
      ...
      <div className="app-sdk-fixed app-sdk-inset-0 app-sdk-z-10 app-sdk-w-screen app-sdk-overflow-y-auto app-sdk-p-4 sm:app-sdk-p-6 md:app-sdk-p-20">
        <DialogPanel
          transition
          className="app-sdk-mx-auto app-sdk-max-w-xl app-sdk-transform app-sdk-rounded-xl app-sdk-bg-white app-sdk-p-2 app-sdk-shadow-2xl app-sdk-ring-1 app-sdk-ring-black app-sdk-ring-opacity-5 app-sdk-transition-all data-[closed]:app-sdk-scale-95 data-[closed]:app-sdk-opacity-0 data-[enter]:app-sdk-duration-300 data-[leave]:app-sdk-duration-150 data-[enter]:app-sdk-ease-out data-[leave]:app-sdk-ease-in"
        >
          <Combobox
            onChange={(entry: T) => {
              if (entry) {
          ...
          >
            <ComboboxInput
              autoFocus
              className="app-sdk-w-[calc(100%-2rem)] app-sdk-ring-offset-2 app-sdk-rounded-md app-sdk-border-0 app-sdk-bg-gray-100 app-sdk-px-4 app-sdk-py-2.5 app-sdk-text-gray-900 sm:app-sdk-text-sm"
            ...
            {filteredEntries.length > 0 && (
              <ComboboxOptions
                static
                className="app-sdk-mb-2 app-sdk-max-h-72 app-sdk-scroll-py-2 app-sdk-overflow-y-auto app-sdk-py-2 app-sdk-text-sm app-sdk-text-gray-800"
              >
            ...
            {query !== '' && filteredEntries.length === 0 && (
              <div className="app-sdk-px-4 app-sdk-py-14 app-sdk-text-center sm:app-sdk-px-14">
                <UsersIcon
                  ...
                  aria-hidden="true"
                />
                <p className="app-sdk-mt-4 app-sdk-text-sm app-sdk-text-gray-900">
