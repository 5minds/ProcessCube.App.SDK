  ...
  return (
    <div
      className={classNames(
        className,
        'app-sdk-w-1/4 app-sdk-min-w-64 app-sdk-absolute app-sdk-top-0 app-sdk-right-0 app-sdk-z-20 app-sdk-pt-2 app-sdk-pr-2 app-sdk-transition-all app-sdk-duration-200',
      )}
    >
