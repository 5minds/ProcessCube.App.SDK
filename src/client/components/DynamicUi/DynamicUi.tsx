...
export function DynamicUi(
  ...
  const rootClassNames: string = classNames(
    'app-sdk-default-styles app-sdk-mx-auto app-sdk-block app-sdk-h-full app-sdk-min-h-[200px] app-sdk-rounded-lg content-center sm:app-sdk-w-full sm:app-sdk-max-w-lg',
