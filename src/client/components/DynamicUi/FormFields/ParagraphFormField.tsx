  ...
  return (
    <div
      ...
      className={classNames(
        ...
        // checkbox
        "[&_input[type='checkbox']]:app-sdk-form-checkbox [&_input[type='checkbox']]:app-sdk-border [&_input[type='checkbox']]:app-sdk-h-4 [&_input[type='checkbox']]:app-sdk-w-4 [&_input[type='checkbox']]:app-sdk-rounded [&_input[type='checkbox']]:app-sdk-border-[color:var(--asdk-dui-border-color)] [&_input[type='checkbox']]:app-sdk-text-sky-600 [&_input[type='checkbox']]:hover:app-sdk-border-[color:var(--asdk-dui-border-color)] [&_input[type='checkbox']]:dark:app-sdk-border-2 [&_input[type='checkbox']]:dark:app-sdk-border-solid [&_input[type='checkbox']]:dark:app-sdk-border-transparent [&_input[type='checkbox']]:dark:app-sdk-bg-app-sdk-gray-350 [&_input[type='checkbox']]:dark:app-sdk-text-[#007bff40] [&_input[type='checkbox']]:dark:hover:app-sdk-border-transparent [&_input[type='checkbox']]:dark:hover:checked:app-sdk-bg-app-sdk-gray-350",
      )}
