...
export function UrlFormField(props: DynamicUiComponentProps<string | null>, ref: DynamicUiFormFieldRef) {
    ...
    <div>
      ...
      <div className="app-sdk-mt-1">
        <input
          ...
          placeholder={parsedCustomFormConfig?.placeholder ?? 'https://processcube.io/'}
          name={formField.id}
          aria-describedby={hintId}
          data-form-field-type="url"
        />
      </div>
