  ...
  const rangeInput = (
    <input
      className={classNames(
        'app-sdk-form-input app-sdk-block app-sdk-w-full app-sdk-appearance-auto app-sdk-px-0 app-sdk-rounded-md app-sdk-border-[color:var(--asdk-dui-border-color)] app-sdk-bg-[color:var(--asdk-dui-formfield-background-color)] focus:app-sdk-ring-[color:var(--asdk-dui-focus-color)] focus:app-sdk-border-[color:var(--asdk-dui-focus-color)]',
      )}
      id={formField.id}
      name={formField.id}
      type="range"
      ...
      defaultValue={state !== null ? state?.toString() : defaultMin.toString()}
